module github.com/moneyforward/ddtrace/examples

go 1.24.4

require gopkg.in/DataDog/dd-trace-go.v1 v1.74.2 // indirect

replace github.com/moneyforward/ddtrace/tracing => ../tracing

require github.com/moneyforward/ddtrace/tracing v0.0.0-00010101000000-000000000000
