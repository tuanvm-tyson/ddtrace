...
func TestGenerateCommand_Run_DefaultFlags(t *testing.T) {
	...
	err := cmd.Run([]string{"-p", "github.com/tuanvm-tyson/ddtrace/internal/cli"}, nil)
...
func TestGenerateCommand_Run_CustomOutputDir(t *testing.T) {
	...
	err := cmd.Run([]string{"-p", "github.com/tuanvm-tyson/ddtrace/internal/cli", "-o", "./custom_out"}, nil)
	require.NoError(t, err)
...
func TestGenerateCommand_Run_NoGenerateFlag(t *testing.T) {
	...
	err := cmd.Run([]string{"-p", "github.com/tuanvm-tyson/ddtrace/internal/cli", "-g"}, nil)
	require.NoError(t, err)
